...
=== main ===
    Do you want to recap the info about Lake Sebu?
    + [Yes]
        For the recap, Lake Sebu is one of the Philippines’ most important watersheds and a major provider of irrigation to the provinces of Sultan Kudarat and South Cotabato. 
        ++ [Next]
        ...
        -> DONE
    + [No]
    Alright then, just let me know if you want to recap the info.
    ++[Exit]
-> END